...
def train_model(data_path, model_type='logistic'):
    ...
    classifier.train(df['transcription'].tolist(), df['medical_specialty'].tolist())
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train classical ML model for clinical note classification')
